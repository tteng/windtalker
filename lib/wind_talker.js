  ...
  WindTalker = (function() {
    ...
    WindTalker.prototype.listen = function() {
      ...
      this.client.on('data', function(data) {
        var bite, current_cursor, end_point, i, _i, _len, _ref;
        ...
        if (!_this.found_head) {
          ...
          if (_this.found_head) {
            ...
            console.log("message_size: " + _this.message_size);
          }
        }
        if (_this.delta.length >= (_this.head + 4 + 4 + _this.message_size)) {
          current_cursor = _this.head + 4 + 4;
          end_point = _this.head + 4 + 4 + _this.message_size - 1;
          console.log("end_point should be " + end_point);
          _this.split_and_inflate(current_cursor, end_point);
