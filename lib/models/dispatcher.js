...
(function() {
  ...
  Dispatcher = (function() {
    ...
    Dispatcher.prototype.shSchedule = function() {
      var invokeJob, ruleAftStart, ruleAftStop, ruleDownloadStart, ruleDownloadStop, ruleMorStart, ruleMorStop, stopJob,
        _this = this;
      stopJob = this.stopJob;
      invokeJob = this.invokeJob;
      ...
      schedule.scheduleJob(ruleDownloadStart, function() {
      ...
      return schedule.scheduleJob(ruleDownloadStop, function() {
        return _this.stopJob('sh');
      });
    };
    ...
    Dispatcher.prototype.usSchedule = function() {
      var invokeJob, ruleDownloadStart, ruleDownloadStop, ruleMorStart, ruleMorStop, stopJob,
        _this = this;
      stopJob = this.stopJob;
      invokeJob = this.invokeJob;
      ruleMorStart = new schedule.RecurrenceRule();
