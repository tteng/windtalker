...
(function() {
  var StaticWszParser, WindTalker, exec, fs, net, os, redis, settings, zlib,
    _this = this;
  ...
  WindTalker = (function() {
    ...
    WindTalker.prototype.downloadAndSave = function(market) {
      var cmd, fileName, saveToDb;
      ...
      return exec(cmd, function(error, stdout, stderr) {
        var swp;
        if (error !== null) {
          console.log("[Download][Error][" + market + "]: " + error);
        }
        if (stdout) {
          console.log("[Download][" + market + "][STDOUT]: " + stdout);
        }
        if (stderr) {
          console.log("[Download][" + market + "][STDERROR]: " + stderr);
        }
        swp = new StaticWszParser(fileName, market, saveToDb);
        return swp.parse();
      });
    };
